...
class GradebookTest {
    ...
    void addGrade_test() {
        ...
        Assertions.assertEquals(new Person("Власов", "Дмитрий", "Юрьевич").getSurname(), myBook.getGrade(1, "Введение в дискретную математику и математическую логику").getTeacher().getSurname());
